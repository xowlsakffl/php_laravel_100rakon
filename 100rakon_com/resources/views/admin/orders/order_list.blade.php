...
<div class="section_wrap clearfix">
    ...
    <div class="main_wrap clearfix">
        <div class="classify">
            <ul class="clearfix">
                <li><a href="{{route('admin.orders.index')}}" class="{{ (\Request::input('state'))==null ? 'active' : '' }}">전체</a></li>
                <li><a href="{{route('admin.orders.index', ['state' => '10'])}}" class="{{ (\Request::input('state'))=='10' ? 'active' : '' }}">입금대기</a></li>
                <li><a href="{{route('admin.orders.index', ['state' => '9'])}}" class="{{ (\Request::input('state'))=='9' ? 'active' : '' }}">입금완료</a></li>
                <li><a href="{{route('admin.orders.index', ['state' => '1'])}}" class="{{ (\Request::input('state'))=='1' ? 'active' : '' }}">주문취소</a></li>
                <li><a href="{{route('admin.orders.index', ['state' => '0'])}}" class="{{ (\Request::input('state'))=='0' ? 'active' : '' }}">삭제</a></li>
            </ul>
        </div>
