    ...
    <div class="content_wrap content_view">
        ...
        <div class="main_wrap clearfix">
            <div class="main_wrap_title clearfix">
                <div class="right_btn">
                    <a href="{{route('admin.subscrib-categories.edit', ['sgcdx' => $categoryData->sgcdx])}}">분류 수정</a>
                    <form action="{{route('admin.subscrib-categories.destroy', ['sgcdx' => $categoryData->sgcdx])}}" method="post">
                        @csrf
                        @method('DELETE')
