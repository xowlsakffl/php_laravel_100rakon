    ...
    <div class="content_wrap content_view">
        ...
        <div class="main_wrap clearfix">
            <div class="main_wrap_title clearfix">
                <div class="right_btn">
                    <a href="{{route('admin.outstand-categories.edit', ['oscdx' => $categoryData->oscdx])}}">분류 수정</a>
                    <form action="{{route('admin.outstand-categories.destroy', ['oscdx' => $categoryData->oscdx])}}" method="post">
                        @csrf
                        @method('DELETE')
