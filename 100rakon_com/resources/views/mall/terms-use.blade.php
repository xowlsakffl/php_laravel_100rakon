...
<div id="mall_terms">
    ...
    <h1 class="title">'백락온 쇼핑몰(100rakon.com)' 이용약관(공정거래위원회 표준)</h1>
    <div class="gap"></div>

    <h2>제1조(목적)</h2>
    <h3>
        이 약관은 '(주)백락온' (전자상거래 사업자) 운영하는 100rakON 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.<br/>
        <br/>
    ...
    <h2>제2조(정의)</h2>
    <h3>
        ① “몰”이란 '(주)백락온'가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br/>
        <br/>
    ...
    <h2>제14조(환급)</h2>
    <h3> “몰”은 이용자가 구매신청한 재화 등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체 없이 그 사유를 이용자에게 통지하고 사전에 재화 등의 대금을 받은 경우에는 대금을 받은 날부터 3영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다.</h3>
    <div class="gap"></div>
