...
<div id="mall_myorder">
    ...
    <div class="title">
        ...
        <div class="goto_another" onClick="gen.redirect('myorder-subscrib');">정기배송 주문내역</div>
    </div>
    <div class="header">
    ...
    <div class="items" id="id_items_{{ $key }}">
        ...
        <div class="item">
            <div class="thumbnail"><img src="<?=Storage::url('public/'.$item->product->thumbnail->real_name)?>" /></div>
