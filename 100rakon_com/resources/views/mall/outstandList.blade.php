...
<div class="content_panel">
    ...
    <div class="product_box clearfix">
        ...
        @foreach ($outstands as $outstand)
            <li>
                <a href="{{route('outstand.show', ['osdx' => $outstand->osdx])}}">

                    <div class="product_img">
                        <img src="storage/{{$outstand->thumbnail->real_name}}" alt="" width="100%">
                    </div>
                    <div class="product_name">{{$outstand->name}}</div>
                    @if ($outstand->price_normal > 0)
                        <div class="product_price">
                            
                            <span class="price Roboto" style="color: #CCC;text-decoration: line-through;margin-bottom: 5px">
                                {{number_format($outstand->price_normal)}}
                            </span>
